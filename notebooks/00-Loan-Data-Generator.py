...
dbutils.widgets.text('path', '/demo/danske-bank/dlt_loan', 'Storage Path')
...
for i in range(0, int(dbutils.widgets.get('batch_count'))):
  ...
  print(f'Finished writing batch: {i}, path: /dbfs{output_path}/landing/accounts{i}.json')

# COMMAND ----------

dbutils.fs.ls("dbfs:/demo/danske-bank/dlt_loan/landing/")
